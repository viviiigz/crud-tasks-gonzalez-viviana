...
import { getProfileByPkValidation, createProfileValidation, updateProfileValidation, deleteProfileValidation } from "../middlewares/validations/profiles.validations.js";
const router = Router();
//definir las rutas
